...
router.post('/', auth_js_1.default, multer_config_js_1.default, platController_js_1.createPlat);
router.get('/one/:id', auth_js_1.default, platController_js_1.getOnePlat);
router.put('/:id', auth_js_1.default, multer_config_js_1.default, platController_js_1.editPlat);
